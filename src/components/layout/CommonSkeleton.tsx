        ...
        <Card className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm border-0 shadow-xl rounded-2xl overflow-hidden">
          ...
          <CardContent className="p-0">
            <div className="relative">
              <div className="relative bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm p-6">
                <div className="grid grid-cols-4 gap-4 mb-4 pb-3 border-b border-gray-100 dark:border-gray-700">
                  <Skeleton className="h-4 w-16" />
                ...
                {Array.from({ length: 5 }).map((_, index) => (
                  <div
                    key={index.toString()}
                    className="grid grid-cols-4 gap-4 py-3 border-b border-gray-50/50 dark:border-gray-700/50"
                  >
